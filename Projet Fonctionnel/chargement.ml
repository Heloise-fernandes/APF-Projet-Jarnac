...
let chargerPartie nom =
	try
		...
		let (numJ,s9) = chargeNumJ s8 in (pioche,tour,nomj1,numLigne1,remplirtab listab1,score1,main1,nomj2,numLigne2,remplirtab listab2,score2,main2,numJ,true)
	with
	_ -> let _ = Affichage.printPasSauvegarde () in ([],0,"",0,[||],0,[],"",0,[||],0,[],0,false)
